...
.buffer_size [DOUBLE,default 10000] in msec  </td></tr>
...
.apply_fcn  FUNHANDLE
.C          [STRUCT] the trained classifier (which is passed to the apply function)
...
Field          Description
-------------- ----------------------
.time          [DOUBLE: 1xMARKER.QUEUELENGTH] in msec(!) since start </td></tr>
.desc          [CELL: 1xMARKERLENGTH of STRINGs] marker descriptors </td></tr>
.current_time  [DOUBLE] time of last acquired sample since start in msec  </td></tr>
