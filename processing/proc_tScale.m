function fv_tsc= proc_tScale(fv, alpha)
%fv_tsc= proc_tScale(fv, <alpha=0.01>)
%
...
fv_tsc= rmfield(fv, dont_copy);
fv_tsc.x= x_tsc;
fv_tsc.df= df;
fv_tsc.crit= stat_calcTCrit(alpha, df);
fv_tsc.alpha= alpha;
fv_tsc.y= 1;
