...
%     'AntennaType' - CHAR (default 'o'): Specifies how anntennas are drawn, 
%         options are 'o','oo','T','I'.
%     'AntennaColor' - DOUBLE [Nx3] or 'auto' (default): Color of antennas, with
%         'auto' meaning same colors as bars.
%     'AntennaSpec' - PROPLIST: Line specifications for antennas
%Returns:
