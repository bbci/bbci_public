...
optode_pos.emit = mnt_setElectrodePositions(clab.emit);
optode_pos.detect = mnt_setElectrodePositions(clab.detect);
...
for emitIdx = 1:nEmit
   ...
   [channel_info{emitIdx}, nirs_clab{emitIdx}, pos{emitIdx}] = getNeighbouringNirsChannels(emitIdx, max_dist, d, optode_pos,clab);
end
