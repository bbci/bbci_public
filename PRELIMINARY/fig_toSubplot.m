...
props= {'Hmain',                [],                     'HANDLE';
        'Rowscols',             [],                     'INT[1 2]|INT[2 1]';
        'Rows',                 [],                     'DOUBLE[1 -]|DOUBLE[- 1]';
        'Cols',                 [],                     'DOUBLE[1 -]|DOUBLE[- 1]';
        'InnerMargin',          [0 0],                  'DOUBLE[1 2]|DOUBLE[2 1]';
        'OuterMargin',          [10 10 10 10],          'DOUBLE[1 4]|DOUBLE[4 1]';
        'Margin',               [.05 .05 .05 .05],      'DOUBLE[1 4]|DOUBLE[4 1]';
        'Positions',            [],                     'DOUBLE[- 4]';
        'DeleteFigs',           0,                      'BOOL';
        'Label',                [],                     'CHAR((a) a a. (1) 1 1.)';
        'LabelPos',             'northwest',                'CHAR|INT';
        'LabelOpt',             {'FontSize' 14 'FontWeight' 'bold'}  'CELL'
        };
